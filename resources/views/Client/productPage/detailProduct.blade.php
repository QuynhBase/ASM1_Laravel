                ...
                <div class="container">
                    <nav class="py-4 lh-30px" aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center py-1 mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $productPage->name }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row ">
                    ...
                    <div class="position-sticky top-0">
                        <div class="slick-slider g-0 "
                            ...
                            <a href="" data-gallery="gallery4" data-thumb-src=""><img
                                    src="{{ Storage::url($productPage->image) }}" data-src="" class="lazy-image"
                                    width="540" height="720" alt></a>
                            {{-- <a href="../assets/images/shop/product-gallery-06.jpg" data-gallery="gallery4"
                                data-thumb-src="../assets/images/shop/product-gallery-06.jpg"><img src="#"
                                    data-src="../assets/images/shop/product-gallery-06.jpg" class="lazy-image"
                                    width="540" height="720" alt></a>
                            <a href="../assets/images/shop/product-gallery-07.jpg" data-gallery="gallery4"
                                data-thumb-src="../assets/images/shop/product-gallery-07.jpg"><img src="#"
                                    data-src="../assets/images/shop/product-gallery-07.jpg" class="lazy-image"
                                    width="540" height="720" alt></a>
                            <a href="../assets/images/shop/product-gallery-08.jpg" data-gallery="gallery4" --}}
                            {{-- data-thumb-src="../assets/images/shop/product-gallery-08.jpg"><img src="#"
                                    data-src="../assets/images/shop/product-gallery-08.jpg" class="lazy-image"
                                    width="540" height="720" alt></a> --}}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 pt-md-0 pt-10">
                    <p class="d-flex align-items-center mb-6">
                        ...
                        <span class="fs-18px text-body-emphasis ps-6 fw-bold">{{ $productPage->price }}₫</span>
                        <span class="badge text-bg-primary fs-6 fw-semibold ms-7 px-6 py-3">20%</span>
                    </p>
                    <h1 class="mb-4 pb-2 fs-4">{{ $productPage->name }}</h1>
                    ...
                    <form action="" enctype="multipart/form-data">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-12">
                                <a href="{{route('client.carts.store', $productPage->id)}}">
                                <button type="submit"
                    ...
                    <ul class="single-product-meta list-unstyled border-top pt-7 mt-7">
                        ...
                        <li class="d-flex mb-4 pb-2 align-items-center">
                            ...
                            <span class="ps-4">{{ $productPage->category_id }}</span>
                        </li>
                    </ul>
                    <div class="mt-11">
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div class="pt-8 pb-3">
                                    <p class="fw-semibold text-body-emphasis mb-2 pb-4">{{ $productPage->description }}</p>
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="pt-8 pb-3">
                                    ...
                                    <ul class="ps-6 mb-8">
                                        <li class="mb-3">Đọc nhãn. Thực hiện theo mọi hướng dẫn và chú ý mọi cảnh báo.
                                        </li>
                                        <li class="mb-3">Rửa tay trước khi sử dụng sản phẩm.</li>
                                        <li class="mb-3">Không dùng chung đồ trang điểm.</li>
                                        <li class="mb-3">Giữ hộp đựng sạch sẽ và đóng chặt khi không sử dụng, tránh xa
                                        ...
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end py-5 ps-5 pe-0">Chiết xuất Nannochloropsis Oculata
                                                        (tảo nhỏ), pullulan
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end py-5 ps-5 pe-0">Hòa tan trong nước và etanol</td>
                                                </tr>
                                                <tr>
        ...
        <section class="container pt-15 pb-15 pt-lg-17 pb-lg-20">
            ...
            <div class="collapse mb-14" id="customer-review">
                <form class="product-review-form">
                    ...
                    <div class="form-group mb-10">
                        <label class="mb-4 fs-6 fw-semibold text-body-emphasis" for="reviewMessage">Trải nghiệm chung của
                            bạn thế nào?</label>
            ...
            <div class=" mt-12">
                ...
                <div class="border-bottom pb-7 pt-10">
                    ...
                    <p class="mb-10 fs-6">I order the samples so as not to make mistakes when choosing my color Is a good
                ...
                {{-- <div class="border-bottom pb-7 pt-10">
                    ...
                    <div class="mb-10"><img src="#" data-src="../assets/images/others/single-product-03.jpg"
                ...
                <div class="border-bottom pb-7 pt-10">
                    ...
                    <p class="fw-semibold fs-6 text-body-emphasis mb-5">Favorite Foundation</p>
                    <p class="mb-10 fs-6">I order the samples so as not to make mistakes when choosing my color Is a good
                        product as a light shade but the sample doesn’t contain enough product to cover the skin and decide
                        clearly, around my eyes I used the “peach bisque”.I used with primer all mu face and finished
                        texture is good. At the end for my latin tan skin a choose “golden peach” But is out of stock the
                        primer I think is a good match.</p>
                    <div class="d-flex justify-content-end align-items-center">
                        <a href="#" class="fs-14px mb-0 text-secondary">Was This Review Helpful?</a>
                        <p class="mb-0 ms-7 text-body-emphasis">
                            <svg class="icon icon-like align-baseline">
