...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/home-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2024 03:23:51 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Home Page 02 - Glowing - Bootstrap 5 HTML Templates</title>
    <link rel="icon" href="{{ asset('theme/assets/images/others/favicon.ico') }}">
    <link rel="stylesheet" href="{{ asset('theme/assets/vendors/lightgallery/css/lightgallery-bundle.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('theme/assets/vendors/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/assets/vendors/mapbox-gl/mapbox-gl.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('theme/cdn.jsdelivr.net/npm/bootstrap-icons%401.9.1/font/bootstrap-icons.css') }}">
    <link
...
<body>
            ...
            <div class="bg-primary bg-opacity-15">
                <div class="container-xxl container d-flex py-4">
                    ...
                    <div class="w-100 text-center">
                        <p class="mb-0 fs-14px fw-bold text-primary text-uppercase">Free shipping on all U.S. orders $50+
                        </p>
                    </div>
                    <div class="w-50 d-none d-lg-block">
                                ...
                                <ul class="navbar-nav w-100 w-xl-auto">
                                    <li
                                        ...
                                        <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px "
                                            href="index-2.html" id="menu-item-home" aria-haspopup="true"
    ...
    {{-- <main id="content" class="wrapper layout-page">
            ...
            <div class="slick-slider hero hero-header-02 slick-slider-dots-inside"
                ...
                <div class="vh-100 d-flex align-items-center">
                    <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
                        <div class="hero-content text-start">
                            <div data-animate="fadeInDown">
                                ...
                                <h1 class="mb-15 text-white hero-title-2 fw-500">Body Daily<br>Oil Wash</h1>
                            </div>
                    ...
                    <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100  "
                        data-bg-src="{{asset('theme/assets/images/hero-slider/hero-slider-04.jpg')}}">
                    </div>
                    <div data-animate="fadeInDown"
                        class="hero-creative-dots position-absolute bottom-0 mb-7 start-50 translate-middle-x"><span
                            class="fs-5 fw-semibold text-white px-5 active active-first">01.</span><span
                            class="fs-5 fw-semibold text-white px-5 ">02.</span><span
                            class="fs-5 fw-semibold text-white px-5 ">03.</span></div>
                </div>
                <div class="vh-100 d-flex align-items-center">
                    <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
                        <div class="hero-content text-start">
                            <div data-animate="fadeInDown">
                                <p class="text-white mb-8 fw-semibold fs-4">Shop Our Set</p>
                                <h1 class="mb-15 text-white hero-title-2 fw-500">The 3-Step<br>Skincare Routine</h1>
                            </div>
                            <a href="#" data-animate="fadeInUp"
                                class="pb-2 bg-transparent fw-semibold text-decoration-none hero-link btn btn-link p-0 text-white">
                                Discover Now
                    ...
                    <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100  "
                        data-bg-src="{{asset('theme/assets/images/hero-slider/hero-slider-05.jpg')}}">
                    </div>
                    <div data-animate="fadeInDown"
                        class="hero-creative-dots position-absolute bottom-0 mb-7 start-50 translate-middle-x"><span
                            class="fs-5 fw-semibold text-white px-5 ">01.</span><span
                            class="fs-5 fw-semibold text-white px-5 active">02.</span><span
                            class="fs-5 fw-semibold text-white px-5 ">03.</span></div>
                </div>
                <div class="vh-100 d-flex align-items-center">
                    <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
                        <div class="hero-content text-start">
                            <div data-animate="fadeInDown">
                                <p class="text-white mb-8 fw-semibold fs-4">New Arrivals</p>
                                <h1 class="mb-15 text-white hero-title-2 fw-500">Cleanser<br>Concentrate</h1>
                            </div>
                            <a href="#" data-animate="fadeInUp"
                                class="pb-2 bg-transparent fw-semibold text-decoration-none hero-link btn btn-link p-0 text-white">
                                Discover Now
                    ...
                    <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100  "
                        data-bg-src="{{asset('theme/assets/images/hero-slider/hero-slider-06.jpg')}}">
                    </div>
                    <div data-animate="fadeInDown"
                        class="hero-creative-dots position-absolute bottom-0 mb-7 start-50 translate-middle-x"><span
                            class="fs-5 fw-semibold text-white px-5 ">01.</span><span
                            class="fs-5 fw-semibold text-white px-5 ">02.</span><span
                            class="fs-5 fw-semibold text-white px-5 active active-last">03.</span></div>
                </div>
            </div>
        </section>
            ...
            <div class="pt-14 pb-14 pt-lg-19 pb-lg-16">
                <div class="container container-xxl mb-13 d-xl-flex">
                    <div class="flex-grow-1 text-left" data-animate="fadeInUp">
                        ...
                        <p class="fs-18px mb-0 mw-xl-40 mw-lg-50 mw-md-75">Looking for something specific? Shop by
                            category to find your perfect piece of jewellery!</p>
                    </div>
                </div>
                            ...
                            <div class="card card-product grid-1 bg-transparent border-0">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                    <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                        ...
                                        <img src="{{asset('theme/assets/images/products/product-01-330x440.jpg')}}" data-src=""
                            ...
                            <div class="card card-product grid-1 bg-transparent border-0">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                    <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                        ...
                                        <img src="{{asset('theme/assets/images/products/product-02-330x440.jpg')}}" data-src=""
                            ...
                            <div class="card card-product grid-1 bg-transparent border-0">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                    <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                        ...
                                        <img src="{{asset('theme/assets/images/products/product-03-330x440.jpg')}}" data-src=""
                            ...
                            <div class="card card-product grid-1 bg-transparent border-0">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                    <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                        ...
                                        <img src="{{asset('theme/assets/images/products/product-04-330x440.jpg')}}"
                                            data-src=""
                            ...
                            <div class="card card-product grid-1 bg-transparent border-0">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                    <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                        ...
                                        <img src="{{asset('theme/assets/images/products/product-05-330x440.jpg')}}"
                                            data-src=""
                        ...
                        <div data-animate="fadeInUp">
                            <div class="card card-product grid-1 bg-transparent border-0">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                    <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                        title="Enriched Duo">
                                        <img src="{{asset('theme/assets/images/products/product-06-330x440.jpg')}}"
                                            data-src=""
                        ...
                        <div data-animate="fadeInUp">
                            <div class="card card-product grid-1 bg-transparent border-0">
                                <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                    <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                        title="Shield Spray">
                                        <img src="{{asset('theme/assets/images/products/product-07-330x440.jpg')}}"
                                            data-src=""
                                ...
                                <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                        class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                        <a class="text-decoration-none text-reset"
                                            href="shop/product-details-v1.html">Shield Spray</a></h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                        <div class="rating">
                                            <div class="empty-stars">
                                                <span class="star">
                ...
                <div class="row align-items-end">
                    <div class="col-lg-4 order-2 order-lg-1 px-xl-6 pb-16 pt-12 py-lg-18 py-xl-22"
                        ...
                        <div class="text-left">
                            ...
                            <h2 class="fs-20 w-md-50 w-lg-100 w-xl-80 mb-4 me-7 me-md-25">Discover Our Autumn Skincare
                            </h2>
                            <p class="fs-18px mb-0 text-body-calculate">Made using clean, non-toxic ingredients, our
                                products are designed for everyone.</p>
                        </div>
                        <a href="#" class="mt-10 btn btn-white shadow-sm">Explore More</a>
                    </div>
                    <div class="col-lg-8 order-1 order-lg-2" data-animate="fadeIn">
                        <img class="lazy-image img-fluid light-mode-img" src="{{asset('theme/assets/images/others/other-bg.png')}}"
                            data-src="" width="923" height="640"
                            alt="other-01">
                        <img class="lazy-image dark-mode-img img-fluid" src="#"
                            data-src="./assets/images/others/other-bg-white.png" width="923" height="640"
                            alt="other-01">
                    </div>
                </div>
            </div>
        ...
        <section class="container container-xxl pt-15 pb-16 pb-lg-18 pt-lg-19">
            <div class="text-center" data-animate="fadeInUp">
                ...
                <h2 class="mb-6">Because You Need Time for Yourself. <br> Blend Beauty in You</h2>
            </div>
            <div class="row mt-13">
                <div class="col-lg-3 col-md-6 col-12" data-animate="fadeInUp">
                    <div class="card border-0">
                        <a href="#" class="hover-shine img-scale overflow-hidden">
                            <img class="lazy-image card-img-top img-scale-change img-fluid light-mode-img"
                                src="{{asset('theme/assets/images/shop/product-cate.jpg')}}" data-src="" width="545"
                                height="611" alt="Bodycare">
                            <img class="lazy-image dark-mode-img card-img-top img-scale-change img-fluid"
                                src="#" data-src="./assets/images/shop/product-cate-white.jpg"
                                width="545" height="611" alt="Bodycare">
                        </a>
                        <div class="card-body text-center px-0 py-7">
                            <h4 class="card-title fw-semibold mb-5"><a href="#">Bodycare</a></h4>
                ...
                <div class="col-lg-3 col-md-6 col-12" data-animate="fadeInUp">
                    <div class="card border-0">
                        <a href="#" class="hover-shine img-scale overflow-hidden">
                            <img class="lazy-image card-img-top img-scale-change img-fluid light-mode-img"
                                src="{{asset('theme/assets/images/shop/product-cate-2.jpg')}}" data-src="" width="545"
                                height="694" alt="Skincare">
                            <img class="lazy-image dark-mode-img card-img-top img-scale-change img-fluid"
                                src="#" data-src="./assets/images/shop/product-cate-white-2.jpg"
                                width="545" height="694" alt="Skincare">
                        </a>
                        <div class="card-body text-center px-0 py-7">
                            <h4 class="card-title fw-semibold mb-5"><a href="#">Skincare</a></h4>
                ...
                <div class="col-lg-3 col-md-6 col-12" data-animate="fadeInUp">
                    <div class="card border-0">
                        <a href="#" class="hover-shine img-scale overflow-hidden">
                            <img class="lazy-image card-img-top img-scale-change img-fluid light-mode-img"
                                src="{{asset('theme/assets/images/shop/categories-03.jpg')}}" data-src="" width="545"
                                height="545" alt="Accessories">
                            <img class="lazy-image dark-mode-img card-img-top img-scale-change img-fluid"
                                src="#" data-src="./assets/images/shop/categories-white-03.jpg"
                                width="545" height="545" alt="Accessories">
                        </a>
                        <div class="card-body text-center px-0 py-7">
                            <h4 class="card-title fw-semibold mb-5"><a href="#">Accessories</a></h4>
                ...
                <div class="col-lg-3 col-md-6 col-12" data-animate="fadeInUp">
                    <div class="card border-0">
                        <a href="#" class="hover-shine img-scale overflow-hidden">
                            <img class="lazy-image card-img-top img-scale-change img-fluid light-mode-img"
                                src="{{asset('theme/assets/images/shop/categories-04.jpg')}}" data-src="" width="545"
                                height="694" alt="Haircare">
                            <img class="lazy-image dark-mode-img card-img-top img-scale-change img-fluid"
                                src="#" data-src="./assets/images/shop/categories-white-04.jpg"
                                width="545" height="694" alt="Haircare">
                        </a>
                        <div class="card-body text-center px-0 py-7">
                            <h4 class="card-title fw-semibold mb-5"><a href="#">Haircare</a></h4>
            ...
            <div class="text-center mt-10">
                <a href="https://templates.g5plus.net/shop/shop-layout-v1.html" target="_blank"
            ...
            <div class="container container-xxl">
                <div class="row align-items-center">
                    <div class="col-lg-7 position-relative" data-animate="fadeIn">
                        <img class="lazy-image img-fluid light-mode-img" src="{{asset('theme/assets/images/Countdown/Countdown-01.png')}}"
                            data-src="" width="774" height="640"
                            alt="Countdown">
                        <img class="lazy-image dark-mode-img img-fluid" src="#"
                            data-src="./assets/images/Countdown/Countdown-white-01.png" width="774"
                            height="640" alt="Countdown">
                        <div
                            class="lable-sale-countdown fw-nomal py-9 px-9 d-none fs-5 bg-primary rounded-circle d-xl-flex align-items-center justify-content-center flex-column text-white position-absolute">
                            Save<span class="fs-23px fw-semibold">$19.00</span></div>
                    </div>
                    <div class="col-lg-5 py-lg-0 py-13" data-animate="fadeInUp">
                        <div class="text-left">
                            <p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">SPECIAL OFFER <span
                                    class="badge bg-primary fs-15px fw-500 ms-4">-20%</span></p>
                            <h2 class="mb-6">Mountain Pine Bath Oil</h2>
                            <p class="fs-18px mb-4 me-md-25 me-lg-0 me-xl-20 text-body-calculate">Made using clean,
            ...
            <div class="pt-14 pb-15 py-lg-18 mb-3 mt-1">
                <div class="container">
                    <div class="text-center" data-animate="fadeInUp">
                        ...
                        <p class="fs-18px mb-0 mw-xl-50 mw-lg-75 ms-auto me-auto">Our bundles were designed to
                            ...
                            <article class="card card-post-grid-3 bg-transparent border-0" data-animate="fadeInUp">
                                <figure class="card-img-top mb-8 position-relative"><a href="#"
                                        ...
                                        <img data-src=""
                                            ...
                                            alt="How to Plop Hair for Bouncy, Beautiful Curls" width="450"
                                            height="290" src="{{asset('theme/assets/images/blog/post-01-450x290.jpg')}}">
                                    </a></figure>
                        ...
                        <div>
                            <article class="card card-post-grid-3 bg-transparent border-0" data-animate="fadeInUp">
                                <figure class="card-img-top mb-8 position-relative"><a href="#"
                                        ...
                                        <img data-src=""
                                            class="img-fluid lazy-image w-100"
                                            alt="Which foundation formula is right for your skin?" width="450"
                                            height="290" src="{{asset('theme/assets/images/blog/post-05-450x290.jpg')}}">
                                    </a></figure>
                                <div class="card-body p-0">
                                    <ul
                                        class="post-meta list-inline lh-1 d-flex flex-wrap fs-13px text-uppercase ls-1 fw-semibold m-0">
                                    ...
                                    <h4 class="card-title lh-base mt-5 pt-2 mb-0">
                                        <a class="text-decoration-none"
                                            href="https://templates.g5plus.net/blog/details-01.html"
                                            title="Which foundation formula is right for your skin?">Which foundation
                                            formula is right for your skin?</a>
                                    </h4>
                                </div>
                            </article>
                        </div>
                        <div>
                            <article class="card card-post-grid-3 bg-transparent border-0" data-animate="fadeInUp">
                                <figure class="card-img-top mb-8 position-relative"><a href="#"
                                        ...
                                        <img data-src=""
                                            class="img-fluid lazy-image w-100"
                                            alt="How To Choose The Right Sofa for your home" width="450"
                                            height="290" src="{{asset('theme/assets/images/blog/post-06-450x290.jpg')}}">
                                    </a></figure>
                                <div class="card-body p-0">
                                    <ul
                                        class="post-meta list-inline lh-1 d-flex flex-wrap fs-13px text-uppercase ls-1 fw-semibold m-0">
                                    ...
                                    <h4 class="card-title lh-base mt-5 pt-2 mb-0">
                                        <a class="text-decoration-none"
                                            href="https://templates.g5plus.net/blog/details-01.html"
                                            title="How To Choose The Right Sofa for your home">How To Choose The Right
                        ...
                        <div class="form-check d-flex justify-content-center">
                            ...
                            <label class="form-check-label text-body fs-14px" for="flexCheckDefault">
                                I accept the <a href="#" class="text-decoration-none text border-bottom">terms
                                    ...
                                    class="text-decoration-none border-bottom">the data protection</a>
                            </label>
                        </div>
                    </div>
                </form>
                ...
                <div class="mx-n6 slick-slider"
                    ...
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-01.jpg" title="instagram-01"
                            ...
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="" alt="instagram-01"
                                src="{{asset('theme/assets/images/instagram/instagram-01-320x320.jpg')}}">
                    ...
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-02.jpg" title="instagram-02"
                            ...
                            class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="" alt="instagram-02"
                                src="{{asset('theme/assets/images/instagram/instagram-02-320x320.jpg')}}">
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-03.jpg" title="instagram-03"
                            ...
                            class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="" alt="instagram-03"
                                src="{{asset('theme/assets/images/instagram/instagram-03-320x320.jpg')}}">
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-04.jpg" title="instagram-04"
                            ...
                            class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="" alt="instagram-04"
                                src="{{asset('theme/assets/images/instagram/instagram-04-320x320.jpg')}}">
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-05.jpg" title="instagram-05"
                            ...
                            class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="" alt="instagram-05"
                                src="{{asset('theme/assets/images/instagram/instagram-05-320x320.jpg')}}">
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-06.jpg" title="instagram-06"
                            ...
                            class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="" alt="instagram-06"
                                src="{{asset('theme/assets/images/instagram/instagram-06-320x320.jpg')}}">
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                </div>
    ...
    {{-- Endfooter --}}
    <script src="{{ asset('theme/cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/bootstrap/js/bootstrap.bundle.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/clipboard/clipboard.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/vanilla-lazyload/lazyload.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/waypoints/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/lightgallery/lightgallery.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/lightgallery/plugins/zoom/lg-zoom.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/lightgallery/plugins/video/lg-video.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js') }}">
    </script>
    <script src="{{ asset('theme/assets/vendors/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/slick/slick.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/gsap/gsap.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/gsap/ScrollToPlugin.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/gsap/ScrollTrigger.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/mapbox-gl/mapbox-gl.js') }}"></script>
            ...
            <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
                <div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
                    <a href="index.html" class="navbar-brand py-4 d-lg-inline-block">
                        <img src="{{ asset('theme/assets/images/others/logo.png') }}" height="26"
                        ...
                        <tr class="position-relative">
                            ...
                            <td class="shop-product">
                                <div class="d-flex align-items-center">
                                    <div class="me-6">
                                        <img src="{{ asset('theme/assets/images/products/product-03-75x100.jpg') }}"
                        ...
                        <div class="d-flex align-items-center mt-8 mb-7">
                            <div class="form-check">
                                ...
                                <label class="custom-control-label text-body" for="agreePolicyTerm">Yes, I agree
                                    with Grace <a href="#" class="text-black">Privacy Policy</a> and <a
                    ...
                    <div class="row ">
                                ...
                                <div id="slider"
                                    ...
                                    <a href="assets/images/shop/product-gallery-05.jpg" data-gallery="gallery1"
                                        data-thumb-src="assets/images/shop/product-gallery-05.jpg"><img
                                            src="#" data-src="./assets/images/shop/product-gallery-05.jpg"
                                    ...
                                    <a href="assets/images/shop/product-gallery-06.jpg" data-gallery="gallery1"
                                        data-thumb-src="assets/images/shop/product-gallery-06.jpg"><img
                                            src="#" data-src="./assets/images/shop/product-gallery-06.jpg"
                                            class="h-auto lazy-image" width="540" height="720" alt></a>
                                    <a href="assets/images/shop/product-gallery-07.jpg" data-gallery="gallery1"
                                        data-thumb-src="assets/images/shop/product-gallery-07.jpg"><img
                                            src="#" data-src="./assets/images/shop/product-gallery-07.jpg"
                                            class="h-auto lazy-image" width="540" height="720" alt></a>
                                    <a href="assets/images/shop/product-gallery-08.jpg" data-gallery="gallery1"
                                        data-thumb-src="assets/images/shop/product-gallery-08.jpg"><img
                                            src="#" data-src="./assets/images/shop/product-gallery-08.jpg"
                                            class="h-auto lazy-image" width="540" height="720" alt></a>
                                </div>
                            </div>
                            <div class="mt-6">
                        ...
                        <div class="col-md-6 pt-md-0 pt-10">
                            ...
                            <div class="card border-0 bg-body-tertiary rounded text-center mt-7">
                                <div class="pt-8 px-5">
                                    <img class="img-fluid"
                                        src="{{ asset('theme/assets/images/shop/product-info-2.png') }}"
...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/home-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2024 03:24:32 GMT -->
