        ...
        <div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
            ...
            <div class="col-sm-12 col-lg-4 text-md-center order-1 order-lg-2 ">
                <a class="d-inline-block" href="index.html">
                    <img class="lazy-image img-fluid light-mode-img"
                        src="{{ asset('theme/assets/images/others/logo.png') }}" data-src=""
                        width="179" height="26" alt="Glowing - Bootstrap 5 HTML Templates">
                    <img class="lazy-image dark-mode-img img-fluid"
                        src="{{ asset('theme/assets/images/others/logo-white.png') }}" data-src=""
                        width="179" height="26" alt="Glowing - Bootstrap 5 HTML Templates">
                </a>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4 order-3 text-sm-start text-lg-end mt-11 mt-lg-0">
                <img src="{{ asset('theme/assets/images/footer/img_1.png') }}" data-src="" width="313"
