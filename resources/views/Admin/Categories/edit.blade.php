...
@section('content')
    ...
    <input type="text" name="id" placeholder="ID" class="form-control" id="product-title" value="{{$category->id}}" disabled>
    </div>
    <div class="mb-7">
