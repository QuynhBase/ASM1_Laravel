...
<div class="row mb-9 align-items-center justify-content-between">
    ...
    <h2 class="fs-4 mb-0">Danh sách danh mục</h2>
    ...
    <a href="{{route('admin.categories.edit', $item->id)}}" class="btn btn-primary py-4 px-5 btn-xs fs-13px me-4"><i class="far fa-pen me-2"></i>Sửa</a>
    <form action="{{route('admin.categories.destroy', $item->id)}}" method="POST">
        @csrf
        @method('DELETE')
        <button class="btn btn-outline-primary btn-hover-bg-danger btn-hover-border-danger btn-hover-text-light py-4 px-5 fs-13px btn-xs me-4" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')"><i class="far fa-trash me-2"></i>Xóa</button>
    </form>
    </div>
    </td>
    </tr>
