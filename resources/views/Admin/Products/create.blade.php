...
<div class="row mb-9 align-items-center">
    ...
    <h2 class="fs-4 mb-0">Thêm mới sản phẩm</h2>
    </div>
    ...
    <div class="mb-7">
        ...
        @if (!empty($product->image))
            <div style="width: 60px; height: 80px;">
                <img src="{{Storage::url($product->image)}}" style="width: 60px; height: 80px;"  alt="">
            </div>
    ...
    <input type="text" placeholder="Nhập tên sản phẩm" class="form-control" id="product-title" name="name">
    </div>
    </div>
    </div>
    ...
    <input type="text" placeholder=".000 ₫" class="form-control" id="cost" name="price">
    </div>
    </div>
    </div>
