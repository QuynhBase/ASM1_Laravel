...
@section('content')
    ...
    <img src="#" data-src="../assets//images/dashboard/avatar-4.png" alt class="lazy-image rounded-circle" height="40" width="40">
    </div>
    <div>
    ...
    <div class="d-flex align-items-center justify-content-between">
    <div class="w-40px me-5">
    <img src="#" data-src="../assets//images/dashboard/avatar-2.png" alt class="lazy-image rounded-circle" height="40" width="40">
    </div>
    <div>
    <h6 class="fs-14px mb-0 lh-1">Patric Adams</h6>
    <p class="text-muted fs-12px mb-0">Sanfrancisco</p>
    ...
    <div class="d-flex align-items-center justify-content-between">
    <div class="w-40px me-5">
    <img src="#" data-src="../assets//images/dashboard/avatar-3.png" alt class="lazy-image rounded-circle" height="40" width="40">
    </div>
    <div>
    <h6 class="fs-14px mb-0 lh-1">Patric Adams</h6>
    <p class="text-muted fs-12px mb-0">Sanfrancisco</p>
    ...
    <p class="mb-0 fs-13px">Lorem ipsum dolor sit amet consectetur</p>
    </div>
    </li>
    ...
    <p class="mb-0 fs-13px">Debitis nesciunt voluptatum dicta reprehenderit</p>
    </div>
    </li>
    <li class="event-list d-flex align-items-center position-relative">
    <div class="event-timeline-dot">
    ...
    <div class="d-flex flex-row align-items-center">
    <div class="me-6">
    <h6 class="fs-13px mb-0"><span class="d-inline-block me-6 w-50px">05 April</span>
    <svg class="icon text-body-emphasis">
    <use xlink:href="#arrow-right-long"></use>
    </svg>
    </h6>
    </div>
    <p class="mb-0 fs-13px">At vero eos et accusamus et iusto odio dignissi</p>
    </div>
    </li>
    <li class="event-list d-flex align-items-center position-relative">
    <div class="event-timeline-dot">
    ...
    <p class="mb-0 fs-13px">Responded to need “Volunteer Activities</p>
    </div>
    </li>
    </ul>
    </div>
    ...
    </th><th class="align-middle" scope="col">Order ID
    </th>
    ...
    <td>$380</td>
    <td>
    <span class="badge rounded-lg badge-soft-danger border-0 text-capitalize fs-12">Chargeback</span>
    </td>
    <td>
    <svg class="icon me-4">
    <use xlink:href="#credit-card"></use>
    ...
    <td>$404</td>
    <td>
    <span class="badge rounded-lg badge-soft-warning border-0 text-capitalize fs-12">Refund</span>
    </td>
    <td>
    <svg class="icon me-4">
    <use xlink:href="#credit-card"></use>
