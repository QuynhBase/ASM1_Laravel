...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/dashboard/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2024 03:25:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('theme/cdn.jsdelivr.net/npm/select2%404.0.13/dist/css/select2.min.css') }}" />
    <link rel="stylesheet"
        href="{{ asset('theme/cdn.jsdelivr.net/npm/select2-bootstrap-5-theme%401.3.0/dist/select2-bootstrap-5-theme.min.css') }}" />
</head>
...
<body>
                            ...
                            <ul class="list-group list-group-flush list-group-no-border w-100 p-6">
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                                    <a href="{{ route('admin.dashboard') }}"
                                        ...
                                        <span class="sidebar-item-text fs-14px fw-semibold">Bảng điều khiển</span>
                                    </a>
                                </li>
                                ...
                                <li class="list-group-item px-0 py-0 sidebar-item mb-3 has-children border-0">
                                    <a href="{{ route('admin.categories.index') }}"
                                        ...
                                        aria-expanded="false" title="Danhmuc">
                            ...
                            <div
                                ...
                                <div class="dropdown px-4 mx-3 py-2 dropdown-language">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item text-brand" href="#"><img
                                                src="../assets/images/dashboard/flag-us.png"
                                                alt="English">English</a>
                                        <a class="dropdown-item" href="#"><img
                                                src="{{ asset('theme/assets/images/dashboard/flag-fr.png') }}"
                                                alt="Français">Français</a>
                                        <a class="dropdown-item" href="#"><img
                                                src="{{ asset('theme/assets/images/dashboard/flag-jp.png') }}"
                                                alt="Français">Français</a>
                                        <a class="dropdown-item" href="#"><img
                                                src="{{ asset('theme/assets/images/dashboard/flag-cn.png') }}"
                                                alt="Français">Français</a>
                                    </div>
                                </div>
                                <div class="dropdown pl-2 py-2">
                                    <a href="#"
                                        ...
                                        data-bs-toggle="dropdown">
                                        <img src="{{ asset('theme/assets/images/dashboard/avatar-2.png') }}"
    ...
    <script src="{{ asset('theme/cdn.jsdelivr.net/npm/select2%404.0.13/dist/js/select2.full.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendors/chartjs/chart.min.js') }}"></script>
    ...
    <script src="{{ asset('theme/assets/js/dashboard.min.js') }}"></script>
...
<!-- Mirrored from templates.g5plus.net/glowing-bootstrap-5/dashboard/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jul 2024 03:25:28 GMT -->
