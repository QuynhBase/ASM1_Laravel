...
<div class="row mb-9 align-items-center justify-content-between">
    ...
    <h2 class="fs-4 mb-0">Danh sách khuyến mãi</h2>
    ...
    <a href="{{route('admin.promotions.show', $item)}}" class="btn btn-primary py-4 px-5 btn-xs fs-13px me-4"><i class="far fa-pen me-2"></i> Xem</a>
    <a href="{{route('admin.promotions.edit', $item)}}" class="btn btn-primary py-4 px-5 btn-xs fs-13px me-4"><i class="far fa-pen me-2"></i> Sửa</a>
    <form action="{{route('admin.promotions.destroy', $item)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('DELETE')
